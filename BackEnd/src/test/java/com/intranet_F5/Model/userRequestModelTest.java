...
class userRequestModelTest {
    ...
    public void initEach(){
        ...
        UserRequestModel requestTest1= new UserRequestModel(1L, myTestUser1, LocalDate.parse("2023-04-02"), LocalDate.parse("2023-04-10"), 1, UserRequestModel.RequestType.Holidays, null);
    }
